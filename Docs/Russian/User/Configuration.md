...
Вы можете изменить место хранения данных HyPrism:

1. Откройте **Настройки** → **Расширенные**
2. Укажите **Каталог данных** с предпочитаемым путём
3. Перезапустите лаунчер
4. Существующие данные нужно будет переместить вручную
